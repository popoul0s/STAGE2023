...
<?php ob_start(); 
if(@$_GET['error'] == 1){
    $loginerror = "Nom d'utilisateur ou Mot de passe incorrect. Réessayer ou ";
}
?>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="index.php?action=login" method="post">
                    <div>
                        ...
                        <input type="text" name="user" id="user" class="bg-gray-50 border border-gray-300 text-gray-200 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-300 dark:border-gray-200 dark:placeholder-gray-700 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Utilisateur" required="">
                    </div>
                    <div>
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-medium text-red-600"><?= @$loginerror?> <a href="#" class="text-sm italic font-medium text-primary-600 hover:underline dark:text-primary-500">Créer un Compte</a></p>
                    </div>
