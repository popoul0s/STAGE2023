                ...
                <div class="flex flex-row">
                    <?php if ($_SESSION['role'] == 'super-admin') { ?>
                        <div class="basis-1/9 mr-6">
                            <a onMouseOver="displayDivInfo('Modifier le Commentaire');" onMouseOut="displayDivInfo()" href="index.php?action=editPostredirection&id=<?= urlencode($post->identifier) ?>" class="mt-1 text-md leading-tight font-medium text-black hover:underline">
                    ...
                    <?php } ?>
                    <div class="basis-1/9">
                        <a onMouseOver="displayDivInfo('Supprimer le Commentaire');" onMouseOut="displayDivInfo()" href="index.php?action=delPost&id=<?= $post->identifier ?>" style="color: red" class="mt-1 text-md leading-tight font-medium text-black hover:underline">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
